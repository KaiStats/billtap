  ...
  <div className="min-h-screen bg-background px-5 py-16">
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="space-y-8 text-muted-foreground leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-3">3. Payments</h2>
          <p>Payment processing is provided by Stripe. All transactions are final once processed. For disputes, contact us at <a href="mailto:hello@billtap.app" className="text-primary">hello@billtap.app</a>.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>Questions? Email us at <a href="mailto:hello@billtap.app" className="text-primary">hello@billtap.app</a></p>
        </section>
      </div>
    </div>
  </div>
