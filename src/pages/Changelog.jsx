      ...
      <section className="py-16" style={{ background: "#0c1220" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            {versions.map((v, i) => (
              <div key={i} className="p-6 rounded-2xl border" style={{ background: "#1e2533", borderColor: "#232d3f" }}>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs" style={{ color: "#8390ae" }}>{v.date}</p>
                  </div>
                </div>
                <ul className="space-y-2">
                  {v.changes.map((change, j) => (
                    <li key={j} className="flex items-start gap-2 text-sm" style={{ color: "#8390ae" }}>
