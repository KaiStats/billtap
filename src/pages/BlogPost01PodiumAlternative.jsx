  ...
  return (
    <main className="min-h-screen" style={{ background: "#070b16" }}>
      <Seo
        ...
        type="article"
        schema={postSchema("podium-alternative", "Why BillTap beats Podium: no integration, no new hardware, reviews captured at the moment of payment instead of days later.")}
      />
