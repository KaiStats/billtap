    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#0a0e1a" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl p-8" style={{ background: "#111827", border: "1px solid #2d3748" }}>
          ...
          <p className="text-sm mb-6" style={{ color: "#8b90a8" }}>Sign in to your account</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-xs" style={{ color: "#00c896" }}>Forgot password?</Link>
            </div>
        ...
        <p className="text-center text-sm mt-6" style={{ color: "#8b90a8" }}>
          ...
          <Link to="/register" style={{ color: "#00c896" }} className="font-semibold">Sign up free</Link>
        </p>
      </div>
    </div>
  );
