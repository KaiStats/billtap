...
import { ROLES } from "../src/lib/art.js";
import {
...
const SETS = [
  { label: "/", manifest: LANDING_ART, dir: LANDING_DIR },
  { label: "/restaurants", manifest: RESTAURANT_ART, dir: RESTAURANTS_DIR },
];
...
for (const { label, manifest, dir } of SETS) {
